...
public class BitmapMessageTest {
    ...
    // add(new Field<String>("0", new NOPDataPackager(0)));
    // add(new Field<String>("1", new NOPDataPackager(0)));
    // add(new Field<Map<String, String>>("2", new AsciiLengthPackager(3), new
    // GenericTLVDataPackager(
    // new AsciiDataPackager(3), new AsciiLengthPackager(3), new
    // AsciiDataPackager())));
    //
    // }
    // };
