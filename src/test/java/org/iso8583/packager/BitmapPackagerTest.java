...
public class BitmapPackagerTest {
    ...
    public void test() throws Exception {
        ...
        assertEquals(
                "\r\n[Bitmap Hex] : [8000000000000000]" + String.format("%n") + "[Bitmap Bit] : [1 ]"
                        + String.format("%n"),
                pkgr.describe());
        ...
        assertEquals("\r\n[Bitmap Hex] : [7F00000000000000]" + String.format("%n") + "[Bitmap Bit] : [2 3 4 5 6 7 8 ]"
    ...
    public void test002() throws Exception {
        ...
        BitmapPackager pkgr = new BitmapPackager(8, false);

        pkgr.unpack(0, new byte[] { (byte) 0xF0, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
                (byte) 0x00, (byte) 0x00 });
        System.out.println(pkgr.describe());
